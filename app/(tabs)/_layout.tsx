...
export default function Layout() {
  ...
  const FORCE_BADGE = 5;
  const displayCount = FORCE_BADGE;

  console.log('[TabLayout] 🎨 Rendering with cartCount:', cartCount, 'type:', typeof cartCount, 'FORCED:', displayCount, 'will show badge:', displayCount > 0);
